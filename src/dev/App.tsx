  ...
  return (
    <Box p='xl'>
      <Stack p='xl' maw='600px' mx='auto'>
        <Title order={1}>Mantine vaul</Title>
        <Group>
          ...
          <ResponsiveDialog
            ...
            <Stack maw='600px' mx='auto'>
              <Text>This component can be used as a Dialog replacement on mobile and tablet devices.</Text>
                ...
                <CopyButton value='pnpm install mantine-vaul'>
                  {({ copy, copied }) => (
                    <Text
                      ...
                      span
                      c={copied ? 'blue' : 'gray'}>
                      pnpm install mantine-vaul (click to copy)
                    </Text>
                  )}
                </CopyButton>
              </Text>
              <Group>
                ...
                <Anchor
                  href='https://github.com/AndrejNemec/mantine-vaul/blob/main/src/dev/App.tsx'
                  target='_blank'
                  rel='noopener'>
                  Code
                </Anchor>
              </Group>
              <Text fw={500}>Try to resize window to see how dialog changes</Text>
            </Stack>
          </ResponsiveDialog>
          <Vaul
            title='Vaul'
            ...
            target={<Vaul.Target component={Button}>Open classic vaul</Vaul.Target>}
            ...
            <Box style={{ height: '100%' }}>
              <Stack maw='600px' mx='auto'>
                ...
                <Vaul
                  ...
                  title='Vaul 2'
                  footer={<Button w='100%'>Hello world</Button>}
                  target={<Vaul.Target component={Button}>Open another vaul</Vaul.Target>}>
                  <Stack maw='600px' mx='auto'>
                    <Vaul.Description>
                ...
                <Button onClick={() => setOpenedAnotherModal(true)}>Open test modal in vaul</Button>
                <Text fw={500}>Scroll test:</Text>
                <Text>
                  This component can be used as a Dialog replacement on mobile and tablet devices. This component can be
                  used as a Dialog replacement on mobile and tablet devices. This component can be used as a Dialog
                  replacement on mobile and tablet devices. This component can be used as a Dialog replacement on mobile
                  and tablet devices.
                </Text>
                <Text>This component can be used as a Dialog replacement on mobile and tablet devices.</Text>
                <Text>This component can be used as a Dialog replacement on mobile and tablet devices.</Text>
        ...
        <Modal opened={openedAnotherModal} onClose={() => setOpenedAnotherModal(false)}>
          <Stack>
            ...
            <Button onClick={() => setOpenedNextModal(true)}>Open next modal</Button>
          </Stack>
        </Modal>
        <Modal opened={openedNextModal} onClose={() => setOpenedNextModal(false)}>
          <Stack>
            <Text>This component can be used as a Dialog replacement on mobile and tablet devices.</Text>
            <TextInput data-autofocus type='text' />
            <Button onClick={() => setOpenedNextModal(false)}>Close</Button>
          </Stack>
        </Modal>
